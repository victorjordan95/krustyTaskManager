define(['ktm'], function (app) {
	app.controller('ChangePasswordCtrl', ['$scope', 'CrudService', '$httpParamSerializer', '$location', 'commonsService', 
	function ($scope, CrudService, $httpParamSerializer, $location, commonsService) {
