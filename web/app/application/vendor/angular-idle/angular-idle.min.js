...
angular.module('ngIdle.title', [])
  .factory('Title', ['$document', '$interpolate', '$filter', function($document, $interpolate, $filter) {
    ...
    return {
      ...
      idleMessage: function(val) {
        return '{{minutes}}:{{seconds}} ' + $filter('translate')('IdleUntilMessage');
      },
      timedOutMessage: function(val) {
        return $filter('translate')('SessionExpiredMessage');
      },
